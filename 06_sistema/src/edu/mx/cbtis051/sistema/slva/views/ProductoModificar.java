...
public class ProductoModificar extends JFrame {
	...
	public boolean actualizarProducto() {
		...
		if (txtNombre.getText().equals("") | txtDescripcion.getText().equals("") | txtModelo.getText().equals("")
				| txtMarca.getText().equals("") | txtImagen.getText().equals("")) {
			JOptionPane.showMessageDialog(ProductoModificar.this, "te faltan campos por llenar");
			return false;
		} else if (Api.updateproducto(pm) != null) {
