...
public class ProductoCatalogo extends JFrame {
	...
	public void agregarProducto() {
		ProductoAgregar ventana = ProductoAgregar.getInstance();
	...
	public void eliminarProducto() {
		...
		if (tproductos.getSelectedRow() != -1) {
			...
			int eliminar = JOptionPane.showConfirmDialog(ProductoCatalogo.this,
			...
			if(eliminar == JOptionPane.YES_OPTION) {
				...
				if(Api.deleteproducto(id) ) {
					JOptionPane.showMessageDialog(ProductoCatalogo.this, "Producto eliminado correctamente.");
					actualizarTProductos();
				}
				else {
					JOptionPane.showMessageDialog(ProductoCatalogo.this, "no se pudo eliminar el producto \n porfavor intentelo de nuevo");
				}
			}
