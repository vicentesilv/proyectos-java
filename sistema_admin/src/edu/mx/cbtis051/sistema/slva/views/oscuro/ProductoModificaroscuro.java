...
public class ProductoModificaroscuro extends JFrame {
	...
	public void actualizarProducto() {
		...
		if(Api.updateproducto(pm) != null ) {
			JOptionPane.showMessageDialog(ProductoModificaroscuro.this, "producto actualizado correctamente");
			this.setVisible(false);
		}else {
			JOptionPane.showMessageDialog(ProductoModificaroscuro.this, "no se pudo actualizar el producto");
		}
